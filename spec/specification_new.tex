...
\subsubsection{Name attribute}
Each \Parameter requires a \textit{name} attribute. This name should be a valid identifier in the \href{http://msdn.microsoft.com/en-us/library/e7f8y25b.aspx}{ANSI C89 standard} and uniquely identify the {\Parameter} from the collection of ports and parameters in the \ComponentClass interface.
...
\subsubsection{Name attribute}
Each \AnalogSendPort requires a \textit{name} attribute. This name should be a valid identifier in the \href{http://msdn.microsoft.com/en-us/library/e7f8y25b.aspx}{ANSI C89 standard} and uniquely identify the {\AnalogSendPort} from the collection of ports and parameters in the \ComponentClass interface.
...
\subsubsection{Name attribute}
Each \AnalogReceivePort requires a \textit{name} attribute. This name should be a valid identifier in the \href{http://msdn.microsoft.com/en-us/library/e7f8y25b.aspx}{ANSI C89 standard} and uniquely identify the {\AnalogReceivePort} from the collection of ports and parameters in the \ComponentClass interface.
...
or \StateVariable. Analog port can have 3 modes:
\begin{itemize}
\item \AnalogSendPort - transmit data originating in this \ComponentClass which can
be read by other {\ComponentClass}es.
\item \AnalogReceivePort - receive data from another {\ComponentClass}es \AnalogSendPort
port. Each \AnalogReceivePort can be connected to \emph{one} \AnalogSendPort.
\item \ReducePort - receive data from multiple \AnalogSendPort. These
differ from \AnalogReceivePort in that they can be connected to multiple
\AnalogSendPort. \AnalogReducePort take an additional operator,
...
\subsubsection{Name attribute}
Each \AnalogSendPort requires a \textit{name} attribute. This name should be a valid identifier in the \href{http://msdn.microsoft.com/en-us/library/e7f8y25b.aspx}{ANSI C89 standard} and uniquely identify the {\AnalogSendPort} in current the \ComponentClass.
