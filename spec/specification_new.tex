...
\newcommand{\MathInline}{\defRef{\tt{Dynamics}}{sec:MathInline}}
\newcommand{\Interface}{\defRef{\textbf{\class{Interface}}\xspace}{sec:Interface}}
...
\newcommand{\Trigger}{\defRef{\tt{Trigger}}{sec:Trigger}}
...
\item \RecvPort - receive data from another {\ComponentClass}es \SendPort
