...
\newcommand{\ComponentClasses}{\textbf{\class{ComponentClass}}es\xspace}
\newcommand{\Dynamics}{\textbf{\class{Dynamics}}\xspace}
\newcommand{\RandomDistribution}{\textbf{\class{RandomDistribution}}\xspace}
\newcommand{\Dynamic}{\textbf{\class{Dynamics}}\xspace}
\newcommand{\MathInline}{\tt{Dynamics}}
\newcommand{\Interface}{\textbf{\class{Interface}}\xspace}
\newcommand{\Interfaces}{\textbf{\class{Interface}}s\xspace}
\newcommand{\StateVariable}{\textbf{\class{StateVariable}}\xspace}
\newcommand{\StateVariables}{\textbf{\class{StateVariable}}s\xspace}
\newcommand{\StateAssignment}{\textbf{\class{StateAssignment}}\xspace}
\newcommand{\StateAssignments}{\textbf{\class{StateAssignment}}s\xspace}
\newcommand{\TimeDerivative}{\textbf{\class{TimeDerivative}}\xspace}
\newcommand{\TimeDerivatives}{\textbf{\class{TimeDerivative}}s\xspace}
\newcommand{\Alias}{\textbf{\class{Alias}}\xspace}
\newcommand{\Aliases}{\textbf{\class{Alias}}es\xspace}
\newcommand{\AnalogPort}{\textbf{\class{AnalogPort}}\xspace}
\newcommand{\AnalogPorts}{\textbf{\class{AnalogPort}}s\xspace}
\newcommand{\EventPort}{\textbf{\class{EventPort}}\xspace}
\newcommand{\EventPorts}{\textbf{\class{EventPort}}s\xspace}
\newcommand{\Port}{\textbf{\class{Port}}\xspace}
\newcommand{\Ports}{\textbf{\class{Port}}s\xspace}
\newcommand{\Event}{\textbf{\class{Event}}\xspace}
\newcommand{\Events}{\textbf{\class{Event}}s\xspace}
\newcommand{\Regime}{\textbf{\class{Regime}}\xspace}
\newcommand{\Regimes}{\textbf{\class{Regime}}s\xspace}
\newcommand{\Transition}{\textbf{\class{Transition}}\xspace}
\newcommand{\Transitions}{\textbf{\class{Transition}}s\xspace}
\newcommand{\Trigger}{\tt{Trigger}}
\newcommand{\OnEvent}{\textbf{\class{OnEvent}}\xspace}
\newcommand{\OnEvents}{\textbf{\class{OnEvent}}s\xspace}
\newcommand{\OnCondition}{\textbf{\class{OnCondition}}\xspace}
\newcommand{\OnConditions}{\textbf{\class{OnCondition}}s\xspace}
\newcommand{\Parameter}{\textbf{\class{Parameter}}\xspace}
\newcommand{\Parameters}{\textbf{\class{Parameter}}s\xspace}
\newcommand{\OutputEvent}{\textbf{\class{OutputEvent}}\xspace}
\newcommand{\OutputEvents}{\textbf{\class{OutputEvent}}s\xspace}
\newcommand{\AnalogSendPort}{\textbf{\class{AnalogSendPort}}\xspace}
\newcommand{\EventSendPort}{\textbf{\class{EventSendPort}}\xspace}
\newcommand{\AnalogReceivePort}{\textbf{\class{AnalogReceivePort}}\xspace}
\newcommand{\AnalogReducePort}{\textbf{\class{AnalogReducePort}}\xspace}
\newcommand{\AnalogSendPorts}{\textbf{\class{AnalogSendPorts}}\xspace}
\newcommand{\AnalogReceivePorts}{\textbf{\class{AnalogReceivePorts}}\xspace}
\newcommand{\AnalogReducePorts}{\textbf{\class{AnalogReducePorts}}\xspace}
\newcommand{\EventReceivePort}{\textbf{\class{EventReceivePort}}\xspace}
\newcommand{\EventReducePort}{\textbf{\class{EventReducePort}}\xspace}
\newcommand{\EventSendPorts}{\textbf{\class{EventSendPorts}}\xspace}
\newcommand{\EventReceivePorts}{\textbf{\class{EventReceivePorts}}\xspace}
\newcommand{\EventReducePorts}{\textbf{\class{EventReducePorts}}\xspace}
...
\begin{table}[hb]
  \begin{edtable}{tabular}{lrr}
    ...
    \Dynamics | \RandomDistribution & singleton & yes \\
    \bottomrule
  \end{edtable}
\end{table}
...
\begin{itemize}
\item \nmlClass{Parameter}s for the \ComponentClass
