...
Cells in the source population are connected to a fixed number of randomly selected cells the destination population. The number of cells is specified by a parameter named \textit{number}. The property supplied to the \textit{number} parameter should be a \SingleValue.

\subsubsubsection{http://nineml.net/9ML/1.0/connectionrules/randomfanin}

Cells in the destination population are connected to a fixed number of randomly selected cells the source population. The number of cells is specified by a parameter named \textit{number}. The property supplied to the \textit{number} parameter should be a \SingleValue.
...
The number of cells in the population is specified by the integer provided in the body of the \Number element. In future versions this may be extended to allow the size of a population to be derived from other features of the \Population. 
