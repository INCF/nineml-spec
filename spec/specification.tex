...
<NineML xmlns="http://nineml.net/9ML/1.0"
	...
	<ComponentClass name="IzhikevichCell">
		...
		<Parameter name="b" dimension="per_voltage_time"/>
		...
		<Dynamics>
			...
			<Regime name="subthresholdRegime">
				...
				<TimeDerivative variable="V">
					<MathInline>0.04*V*V/unitV + 5*V + (140.0 - U)*unitV + (iSyn + iInj)*unitR</MathInline>
				</TimeDerivative>
				<OnCondition>
					<Trigger>
	...
	<Unit name="V" dimension="voltage" power="0"/>
	<Unit name="Ohm" dimension="resistance" power="0"/>
</NineML>
\end{lstlisting}
...
<NineML xmlns="http://nineml.net/9ML/1.0"
  ...
  <Component name="IzhikevichNeuron">
    ...
    <Property name="b" units="per_mV_ms">
  ...
  <Unit symbol="per_mV_ms" dimension="voltage_per_time" />
