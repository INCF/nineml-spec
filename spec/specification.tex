...
\note{The format for units and dimensions was copied from NeuroML version 2.0 (\href{http://www.neuroml.org}{http://www.neuroml.org}).}
...
\subsubsection{Body format}
The body of the \Number element contains an \primtype{integer} representing the size of the population.
...
Each \FromSource element requires a \textit{sender} attribute. This should refer to the name of a \AnalogSendPort or \EventSendPort in the \Cell{}\withelem\Component{}\withelem\ComponentClass of the source population. The transmission mode of the port (i.e. \lq\lq{}analog\rq\rq{} or \lq\lq{}digital\rq\rq{}) should match that of the port referenced by the \textit{receiver} attribute.
