...
The ever increasing diversity of neuronal network models and the software/hardware platforms used to simulate them,
makes sharing, replicability and reusability of neuronal network models, or parts thereof, a challenging problem.
To address this problem, we propose a common description language to facilitate the exchange models between researchers and simulator platforms.
...
\note{The format for units and dimensions is the same as is used for NeuroML version 2.0 (\href{http://www.neuroml.org}{http://www.neuroml.org}).}
