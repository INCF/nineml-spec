...
\newcommand{\ValueSendPort}{\defRef{\textbf{\class{ValueSendPort}}\xspace}{sec:ValueSendPort}}
\newcommand{\ValueReceivePort}{\defRef{\textbf{\class{ValueReceivePort}}\xspace}{sec:ValueReceivePort}}
...
\newcommand{\FromMapID}{\defRef{\textbf{\class{FromMapID}}\xspace}{sec:FromMapID}}
...
\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    ...
    \ValueSendPort & set & no\\    
    \ValueReceivePort & set & no\\     
...
\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{Expression Structure}}}\\
    \toprule
    \em{Element type} & \em{Multiplicity} & \em{Required} \\
    \midrule
...
\subsection{ValueSendPort}
\label{sec:ValueSendPort}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{ValueSendPort Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    name & \identifier & yes\\
...
\subsubsection{Name attribute}
Each \ValueSendPort requires a \textit{name} attribute, which is a valid \identifier and uniquely identifies the \ValueSendPort from all other elements in the \ComponentClass.

\subsubsection{Dimension attribute}
Each \ValueSendPort requires a \textit{dimension} attribute. This attribute specifies the dimension of the units of the quantity that is expected to be communicated through the \ValueSendPort and should refer to the name of a \Dimension element in the global scope.

\subsection{ValueReceivePort}
\label{sec:ValueReceivePort}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{ValueReceivePort Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    name & \identifier & yes\\
...
\subsubsection{Name attribute}
Each \ValueReceivePort requires a \textit{name} attribute, which is a valid \identifier and uniquely identifies the \ValueReceivePort from all other elements in the \ComponentClass.

\subsubsection{Dimension attribute}
Each \ValueReceivePort requires a \textit{dimension} attribute. This attribute specifies the dimension of the units of the quantity that is expected to be communicated through the \ValueReceivePort and should refer to the name of a \Dimension element in the global scope.
...
\ConnectionRule elements are the top-level container for \ComponentClass elements that define network connectivity. Typically, values are read from \AdditionalProperty elements within the source and destination population via \ValueReceivePort{}s .
...
\ConnectCondition elements specify the conditions under which 
...
of the \Component that are derived from \ValueSendPort{}s of components. Their \textit{name} attribute should match the name of the corresponding \Parameter element in the \ComponentClass. 
...
\subsection{AdditionalProperty}
\label{sec:AdditionalProperty}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{AdditionalProperty Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    name & \identifier & yes\\
...
\AdditionalProperty elements are used to append properties to the cells in population that are used by connectivity rules.

\subsubsection{Name attribute}
Each \AdditionalProperty requires a \textit{name} attribute. This should refer to the name of a \Parameter in the corresponding \ComponentClass of the \Component.

\subsubsection{Units attribute}
Each \AdditionalProperty element requires a \emph{units} attribute. The \textit{units} attribute specifies the units of the quantity and should refer to the name of a \Unit element in the global scope. For a dimensionless units a \Unit\withelem\Dimension with no SI dimensions can be used. The SI dimensions of the \Unit\withelem\Dimension should match the SI dimensions of the corresponding \Parameter\withelem\Dimension.
...
\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    ...
    \toprule
     \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    of & source | destination | connection & yes\\
    \bottomrule
  \end{edtable}
\end{table}


\subsection{FromCellProperty}
\label{sec:FromCellProperty}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{FromCellProperty Structure}}}\\
    \toprule
     \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    parameter & \Parameter{}@name & yes\\
    \bottomrule
  \end{edtable}
\end{table}


\subsection{FromAdditionalProperty}
\label{sec:FromAdditionalProperty}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{FromAdditionalProperty Structure}}}\\
    \toprule
     \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    parameter & \Parameter{}@name & yes\\
...
\subsubsection{MapID attribute}
Each \Domain requires a \text{mapID} attribute, which should be a non-negative integer and unique amongst the \Domain element in the enclosing \MultiCompartmental. The \textit{mapID} is used to map the compartments onto the domain.
...
\subsection{FromMapID}
\label{sec:FromMapID}

\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    \toprule
    \multicolumn{3}{c}{\parbox{0.55\linewidth}{\center\textbf{FromMapID Structure}}}\\
    \toprule
    \em{Attribute name} & \em{Type/Format} & \em{Required} \\
    \midrule
    of & source | destination & yes\\
    \bottomrule
  \end{edtable}
\end{table}
