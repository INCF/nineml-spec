...
\draftnote{what about non-spiking neurons and potentially glial cells?}
\begin{enumerate}
...
At the present time to object model has been implemented in three software
tools (using Java, Python and Chicken Scheme), which are able to
import/export a common XML description and generate code for simulating
models in different simulators.
