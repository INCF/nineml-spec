...
%%
%% The NineML Specification Document is free software; you can redistribute it and/or modify it
...
The \textit{m} attribute specifies the power of the mass dimension in the \Dimension. If omitted it the power is one.

\subsubsection{l attribute}
The \textit{l} attribute specifies the power of the length dimension in the \Dimension. If omitted it the power is one.

\subsubsection{t attribute}
The \textit{t} attribute specifies the power of the time dimension in the \Dimension. If omitted it the power is one.

\subsubsection{i attribute}
The \textit{i} attribute specifies the power of the current dimension in the \Dimension. If omitted it the power is one.

\subsubsection{n attribute}
The \textit{n} attribute specifies the power of the amount-of-substance dimension in the \Dimension. If omitted it the power is one.

\subsubsection{k attribute}
The \textit{k} attribute specifies the power of the temperature dimension in the \Dimension. If omitted it the power is one.

\subsubsection{? attribute}
\draftnote{I can\rq{}t find the luminous intensity abbreviation in the NeuroML specs}
The \textit{?} attribute specifies the power of the luminous-intensity dimension in the \Dimension. If omitted it the power is one.
...
%The \textit{index} attribute specifies the index of the \ValueListRow in the \ValueList. It must be non-negative, unique amongst the set of \ValueListRow{}@index in the list, and the set of indices must be contiguous.
...
\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    ...
    \em{Element type} & \em{Multiplicity} & \em{Required} \\
    \midrule
    \Component->\Dynamics | \Reference->\Component->\Dynamics & singleton & yes \\
    \bottomrule
  \end{edtable}
\end{table}
\newpage
...
\begin{table}[H]
  \begin{edtable}{tabular}{llr}
    ...
    \em{Element type} & \em{Multiplicity} & \em{Required} \\
    \midrule
    \Reference->\Population | \Reference->\Set & singleton & yes \\
...
Each \FromSource element requires a \textit{sender} attribute. This should refer to the name of a \AnalogSendPort or \EventSendPort in the \Cell->\Component->\ComponentClass of the source population. The transmission mode of the port (i.e. \lq\lq{}analog\rq\rq{} or \lq\lq{}digital\rq\rq{}) should match that of the port referenced by the \textit{receiver} attribute.

\subsubsection{Receiver attribute}
Each \FromSource element requires a \textit{receiver} attribute. This should refer to the name of a \AnalogReceivePort, \EventReceivePort, \AnalogReducePort or \EventReducePort in the \Component->\ComponentClass in the enclosing \Source/\Destination/\Plasticity/\Response element.  The transmission mode of the port (i.e. \lq\lq{}analog\rq\rq{} or \lq\lq{}digital\rq\rq{}) should match that of the port referenced by the \textit{sender} attribute.
