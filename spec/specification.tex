...
<NineML xmlns="http://nineml.net/9ML/1.0"
  ...
  <ComponentClass name="CoBa">
    ...
    <Parameter dimension="conductance" name="coba_q"/>
    <Dynamics>
			<StateVariable dimension="conductance" name="coba_g"/>
			<Regime name="RegularRegime">
...
<NineML xmlns="http://nineml.net/9ML/1.0"
  ...
  <Projection>
  	...
  	<Connectivity>
  		<ConnectionRule standardlibrary="http://nineml.net/9ML/1.0/connectionrules/onetoone.9ml"/>
  	</Connectivity>
  </Projection>
  <Projection>
  	<Source>
