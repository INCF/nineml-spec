...
The NineML native grammar and semantics give a complete
specification of a domain-specific language that reflects the NineML
object model.
...
schema reflects the NineML object model.
