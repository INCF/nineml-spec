...
Layer level allow us to define the dynamics of a general \ComponentClass.
It is then possible to instantiate several variant of this \ComponentClass by attributing different values for the \Parameters, in the User Layer.
