...
(require-extension datatype static-modules miniML miniMLsyntax miniMLvalue miniMLeval)
(require-extension signal-diagram tree-rewrite ssax sxml-transforms sxpath sxpath-lolevel object-graph uri-generic getopt-long )
...
(define rewrite-ul-components (rewrite-map-tree rule-user-layer-component))
  ...
  (if (null? operands)
	...
	(for-each
	 (lambda (operand)
	   ...
	   (let* ((ul-sxml (parse-sxml operand))
