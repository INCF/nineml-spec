...
class Test_dot_escape(unittest.TestCase):

    def test__dot_escape(self):
        # Signature: name(s)
		# No Docstring
...
# Testing Skeleton for class: DotWriter

class DotWriter_test(unittest.TestCase):
    ...
    def test_build(self):
        # Signature: name(cls, dot_filename, output_types=None)
