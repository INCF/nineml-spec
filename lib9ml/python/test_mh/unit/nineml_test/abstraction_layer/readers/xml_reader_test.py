...
# Testing Skeleton for class: XMLReader

class XMLReader_test(unittest.TestCase):
    ...
    def test_read(self):
        # Signature: name(cls, filename, component_name=None)
...
# Testing Skeleton for class: XMLLoader

class XMLLoader_test(unittest.TestCase):
