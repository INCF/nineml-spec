...
# Testing Skeleton for class: ComponentValidatorEventPorts

class ComponentValidatorEventPorts_test(unittest.TestCase):
    ...
    def test_action_onevent(self):
        # Signature: name(self, on_event, namespace, **kwargs)
		# No Docstring
        #from nineml.abstraction_layer.validators.cv_ports import ComponentValidatorEventPorts
        warnings.warn('Tests not implemented')
        # raise NotImplementedError()
    ...
    def test_action_outputevent(self):
        # Signature: name(self, output_event, namespace, **kwargs)
		# No Docstring
        #from nineml.abstraction_layer.validators.cv_ports import ComponentValidatorEventPorts
        warnings.warn('Tests not implemented')
        # raise NotImplementedError()
...
# Testing Skeleton for class: ComponentValidatorOutputAnalogPorts

class ComponentValidatorOutputAnalogPorts_test(unittest.TestCase):
