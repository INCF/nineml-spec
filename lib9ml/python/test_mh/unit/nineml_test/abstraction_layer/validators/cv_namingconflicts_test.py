...
# Testing Skeleton for class: ComponentValidatorLocalNameConflicts

class ComponentValidatorLocalNameConflicts_test(unittest.TestCase):
    ...
    def test_check_comflicting_symbol(self):
