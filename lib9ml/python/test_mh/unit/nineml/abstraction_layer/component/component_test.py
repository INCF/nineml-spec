...
class ComponentClass_test(object):
...
class ComponentClassMixinFlatStructure_test(object):
...
class ComponentClassMixinNamespaceStructure_test(object):
...
class InterfaceInferer_test(object):
