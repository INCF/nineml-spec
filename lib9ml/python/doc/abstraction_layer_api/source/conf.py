# -*- coding: utf-8 -*-
#
# NineML AbstractionLayer API documentation build configuration file, created by
...
project = u'NineML AbstractionLayer API'
...
htmlhelp_basename = 'NineMLAbstractionLayerAPIdoc'
...
latex_documents = [
  ('index', 'NineMLAbstractionLayerAPI.tex', u'NineML AbstractionLayer API Documentation',
...
texinfo_documents = [
  ('index', 'NineMLAbstractionLayerAPI', u'NineML AbstractionLayer API Documentation', u'Mike Hull, Eilif Muller, Andrew Davison',
   'NineMLAbstractionLayerAPI', 'One line description of project.', 'Miscellaneous'),
]
...
epub_title = u'NineML AbstractionLayer API'
