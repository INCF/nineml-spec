...
class ComponentSymbolsTestCase(unittest.TestCase):
    ...
    def test_add_prefix(self):
        ...
        # prefix
        prefix = 'ABC_'
        c1.add_prefix(prefix)

        # after prefixing, all the inferred stuff should be updated
        print c1.user_parameters
        assert c1.user_parameters == set([prefix+x for x in parameters])
